...
$resourceGroupName = "NitinCIaCS-rg"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/nitinranjan512/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/nitinranjan512/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
